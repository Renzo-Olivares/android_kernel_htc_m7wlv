...
void mali_group_abort_gp_job(struct mali_group *group, u32 job_id)
{
	...
	mali_group_complete_jobs(group, MALI_TRUE, MALI_FALSE, MALI_FALSE); 
}
...
void mali_group_abort_pp_job(struct mali_group *group, u32 job_id)
{
	...
	mali_group_complete_jobs(group, MALI_FALSE, MALI_TRUE, MALI_FALSE); 
}
...
void mali_group_bottom_half(struct mali_group *group, enum mali_group_event_t event)
{
	...
	switch (event)
	{
		case GROUP_EVENT_PP_JOB_COMPLETED:
			mali_group_complete_jobs(group, MALI_FALSE, MALI_TRUE, MALI_TRUE); 
		...
		case GROUP_EVENT_GP_JOB_COMPLETED:
			mali_group_complete_jobs(group, MALI_TRUE, MALI_FALSE, MALI_TRUE); 
		...
		case GROUP_EVENT_MMU_PAGE_FAULT:
			mali_group_complete_jobs(group, MALI_TRUE, MALI_TRUE, MALI_FALSE); 
