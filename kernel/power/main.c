...
#ifdef CONFIG_PERFLOCK_HTC
	perf_lock_init(&user_highest_perf_lock, TYPE_PERF_LOCK, PERF_LOCK_HIGHEST, "User Highest Perflock"); 

	perf_lock_init(&user_high_ceiling_lock, TYPE_CPUFREQ_CEILING, PERF_LOCK_HIGHEST, "User High cpufreq_ceiling lock"); 
