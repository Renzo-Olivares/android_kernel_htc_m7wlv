...
#define BATTERY_TIME_VERSION "2013.12.12_0.0"
...
#if defined(CONFIG_MACH_CP5DUG)||defined(CONFIG_MACH_DUMMY)||defined(CONFIG_MACH_DUMMY)||defined(CONFIG_MACH_DUMMY)||defined(CONFIG_MACH_DUMMY)
	schedule_delayed_work(&mbat_in_work, msecs_to_jiffies(60*1000));
#else
